...
if ( ! function_exists( 'core_corporate_404_section' ) ) :
	...
	* @since 1.0.0
	*/
	function core_corporate_404_section() { ?>
...
add_action( 'core_corporate_action_404_section', 'core_corporate_404_section', 10 );
